...
public class DBCipherManager {
    ...
    private static volatile DBCipherManager instance=null;
    ...
    public  static synchronized DBCipherManager getInstance(Context context){
        if(instance==null){
            synchronized(DBCipherManager.class){
                if(instance==null){
                    instance=new DBCipherManager(context);
                }
            }
        }
        return instance;
